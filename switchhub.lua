...
if _G.Hiru_Hub_Series_R then
	...
	if getgenv().Deleted_Ui then
		...
		game:GetService("CoreGui")["Hiru Hub"].Level.Fragments.TextColor3 = Color3.fromRGB(0, 255, 186) 
		...
		game:GetService("CoreGui")["Hiru Hub"].Text3.Fragments.TextColor3 = Color3.fromRGB(0, 255, 186) 
		...
		F_Text5.Name = "Text5"
		F_Text5.Parent = game:GetService("CoreGui")["Hiru Hub"]
		...
		game:GetService("Players").LocalPlayer.PlayerGui.Main.Fragments:Clone().Parent = game:GetService("CoreGui")["Hiru Hub"].Text5
		game:GetService("CoreGui")["Hiru Hub"].Text5.Fragments.TextColor3 = Color3.fromRGB(245, 245, 245)
		game:GetService("CoreGui")["Hiru Hub"].Text5.Fragments.Text = '...'
		game:GetService("CoreGui")["Hiru Hub"].Text5.Fragments.Size = UDim2.new(1, 0, 0, 25)
		...
		game:GetService("CoreGui")["Hiru Hub"].Text4.Fragments.TextColor3 = Color3.fromRGB(0, 255, 186) 
		...
		ToggleImgUi.Image = "rbxassetid://81062572105889"
